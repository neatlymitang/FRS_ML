function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision]=MLNB(train_data,train_target,test_data,test_target)
...
%           sigma            - A QxN array, where the 标准差standard deviation of the Gaussian distribution for the distribution P(xj|Ci) is stored in sigma(i,j)
%           sigmaN           - A QxN array, where the 标准差standard deviation of the Gaussian distribution for the distribution P(xj|~Ci) is stored in sigmaN(i,j)
%
...
%      [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision]=mlknn(train_data(:,index),train_target,test_data(:,index),test_target);